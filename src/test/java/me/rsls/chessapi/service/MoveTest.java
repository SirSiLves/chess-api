...
public class MoveTest extends ChessApiApplicationTests {
    ...
    public void testValidPawnMoves() {
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"e", "4"}, new String[]{"d", "3"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"c", "2"}, new String[]{"d", "3"}).isState());
    ...
    public void testInvalidPawnMovesAtStart(){
        ...
        assertFalse(handleMoveService.handleMove(new String[]{"g", "3"}, new String[]{"g", "5"}).isState());
    }
    ...
    public void testValidRookMoves(){
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"h", "6"}, new String[]{"d", "6"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"h", "2"}, new String[]{"g", "2"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"d", "6"}, new String[]{"f", "6"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"g", "2"}, new String[]{"g", "3"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"f", "6"}, new String[]{"a", "6"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"g", "3"}, new String[]{"a", "3"}).isState());
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"h", "6"}, new String[]{"b", "6"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"a", "6"}, new String[]{"a", "4"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"b", "6"}, new String[]{"b", "4"}).isState());
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"a", "5"}, new String[]{"e", "5"}).isState());
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"b", "2"}, new String[]{"b", "1"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"e", "5"}, new String[]{"h", "5"}).isState());
    ...
    public void testInvalidRookMoves(){
        ...
        assertFalse(handleMoveService.handleMove(new String[]{"h", "1"}, new String[]{"h", "6"}).isState());
        assertFalse(handleMoveService.handleMove(new String[]{"h", "1"}, new String[]{"g", "3"}).isState());
    ...
    public void testValidBishopMoves(){
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"a", "6"}, new String[]{"c", "4"}).isState());
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"h", "6"}, new String[]{"e", "3"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"a", "3"}, new String[]{"f", "8"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"e", "3"}, new String[]{"d", "2"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"f", "8"}, new String[]{"e", "7"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"d", "2"}, new String[]{"b", "4"}).isState());
    ...
    public void testValidQueenMoves(){
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"h", "4"}, new String[]{"e", "4"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"f", "1"}, new String[]{"e", "2"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"e", "4"}, new String[]{"c", "6"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"g", "5"}, new String[]{"e", "5"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"c", "6"}, new String[]{"e", "6"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"e", "5"}, new String[]{"a", "5"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"e", "6"}, new String[]{"h", "3"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"a", "5"}, new String[]{"a", "7"}).isState());
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"b", "3"}, new String[]{"b", "6"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"d", "5"}, new String[]{"f", "7"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"e", "8"}, new String[]{"d", "8"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"f", "7"}, new String[]{"b", "3"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"b", "6"}, new String[]{"b", "3"}).isState());
    }
    ...
    public void testInvalidQueenMoves(){
        ...
        assertFalse(handleMoveService.handleMove(new String[]{"d", "8"}, new String[]{"e", "6"}).isState());

        assertTrue(handleMoveService.handleMove(new String[]{"d", "8"}, new String[]{"f", "6"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"f", "3"}, new String[]{"f", "6"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"d", "7"}, new String[]{"d", "6"}).isState());

        assertFalse(handleMoveService.handleMove(new String[]{"f", "6"}, new String[]{"c", "3"}).isState());
    }
    ...
    public void testValidKnightMoves(){
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"e", "4"}, new String[]{"f", "6"}).isState());
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"g", "5"}, new String[]{"h", "7"}).isState());
    ...
    public void testValidKingMoves(){
        ...
        assertFalse(handleMoveService.handleMove(new String[]{"f", "6"}, new String[]{"d", "4"}).isState());

        assertTrue(handleMoveService.handleMove(new String[]{"f", "6"}, new String[]{"e", "4"}).isState());

        assertFalse(handleMoveService.handleMove(new String[]{"g", "5"}, new String[]{"g", "8"}).isState());
    }
    ...
    public void testInvalidKingMoves(){
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"e", "6"}, new String[]{"f", "6"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"g", "3"}, new String[]{"g", "4"}).isState());

        assertFalse(handleMoveService.handleMove(new String[]{"f", "6"}, new String[]{"e", "8"}).isState());

        assertTrue(handleMoveService.handleMove(new String[]{"f", "6"}, new String[]{"e", "6"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"g", "4"}, new String[]{"h", "5"}).isState());

        assertFalse(handleMoveService.handleMove(new String[]{"e", "6"}, new String[]{"e", "8"}).isState());
