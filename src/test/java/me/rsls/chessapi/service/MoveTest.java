...
public class MoveTest extends ChessApiApplicationTests {
    ...
    public void testNullPointerMove() {
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"d", "7"}, new String[]{"f", "5"}).isState());
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"c", "8"}, new String[]{"d", "8"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"h", "1"}, new String[]{"h", "4"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"e", "7"}, new String[]{"e", "5"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"c", "4"}, new String[]{"d", "5"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"f", "7"}, new String[]{"f", "5"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"h", "4"}, new String[]{"f", "4"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"g", "8"}, new String[]{"h", "8"}).isState());
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"b", "8"}, new String[]{"b", "6"}).isState());
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"b", "6"}, new String[]{"h", "6"}).isState());
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"h", "6"}, new String[]{"c", "6"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"e", "1"}, new String[]{"f", "1"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"e", "3"}, new String[]{"b", "3"}).isState());
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"g", "1"}, new String[]{"f", "3"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"c", "7"}, new String[]{"d", "8"}).isState());
        ...
        assertTrue(handleMoveService.handleMove(new String[]{"d", "8"}, new String[]{"c", "7"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"f", "3"}, new String[]{"g", "5"}).isState());
        assertTrue(handleMoveService.handleMove(new String[]{"c", "6"}, new String[]{"c", "1"}).isState());
